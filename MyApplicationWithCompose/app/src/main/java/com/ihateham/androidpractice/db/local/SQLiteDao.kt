...
interface SQLiteDao {
    ...
    suspend fun updateData(tableName: String, table: List<String>, value: List<List<String>>)
    suspend fun updateAllData(tableName: String, table: String, value: List<List<String>>)
    suspend fun updateDataSQL(tableName: String, table: List<String>, value: List<List<String>>)
    ...
    suspend fun deleteDataSQL(tableName: String, table: String, deleteKey: List<String>)
    fun close()
}
